...
<div class="hbackground h3back">
    <h3 class="shl padding">Чемпионат Санкт-Петербурга</h3>
</div>

<div class="flex-1 greyback column-container marginlarge">
    <div class="hbackground h3back backlastgames">
        <h3 class="shl padding">Последние матчи</h3>
    </div>
    <div class="flex-1 row-container marginlarge">
        <div class="flex-1 btransparent row-container lastgame">
    ...
    <div class="hbackground h3back backlastgames">
        <h3 class="shl padding">Бомбардиры</h3>
    </div>
    <div class="flex-1 row-container marginlarge">
...
<div class="flex-1 lnbackground column-container marginlarge">
    <div class="hbackground h3back backlastgames">
        <h3 class="shl padding">Турнирная таблица</h3>
    </div>
    <div class="flex-1 greyback">

        <section id="bracket">
            <div class="containersetka">
